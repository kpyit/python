...
# Form implementation generated from reading ui file 'h:\python\configurator_mc34063\res\dialog_load.ui'
#
...
"QLabel {  color: White; }")
        ...
        item = QtWidgets.QTableWidgetItem()
        self.table_components.setHorizontalHeaderItem(6, item)
        item = QtWidgets.QTableWidgetItem()
        self.table_components.setItem(0, 0, item)
        item = QtWidgets.QTableWidgetItem()
        self.table_components.setItem(0, 3, item)
        self.pushButton_3 = QtWidgets.QPushButton(Dialog)
        self.pushButton_3.setGeometry(QtCore.QRect(10, 500, 321, 28))
        self.pushButton_3.setObjectName("pushButton_3")
        self.widget_draw = QtWidgets.QWidget(Dialog)
        self.widget_draw.setGeometry(QtCore.QRect(610, 420, 631, 411))
    ...
    def retranslateUi(self, Dialog):
        ...
        item.setText(_translate("Dialog", "Макс V(В)"))
        item = self.table_components.horizontalHeaderItem(3)
        item.setText(_translate("Dialog", "Макс A(mA)"))
        ...
        item = self.table_components.horizontalHeaderItem(6)
        item.setText(_translate("Dialog", "Cпецификация"))
        ...
        self.pushButton_3.setText(_translate("Dialog", "Ипортировать перечень диодов"))
